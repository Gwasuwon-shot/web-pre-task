...
export default function BeanCalendar() {
  ...
  const myEventsList = [
    ...
    },
    {
      id: 2,
      title: "3 은빈",
      start: new Date(2023, 6, 1, 9, 0), // 시작 시간 (년, 월(0부터 시작), 일, 시간, 분)
      end: new Date(2023, 6, 1, 10, 0), // 종료 시간 (년, 월(0부터 시작), 일, 시간, 분)
      color: "#ff0000",
    },
    {
      id: 3,
      title: "4 은빈",
      start: new Date(2023, 6, 1, 12, 0), // 시작 시간 (년, 월(0부터 시작), 일, 시간, 분)
      end: new Date(2023, 6, 1, 14, 0), // 종료 시간 (년, 월(0부터 시작), 일, 시간, 분)
    },
    {
      id: 4,
      title: "5 은빈",
      start: new Date(2023, 6, 2, 16, 0),
      end: new Date(2023, 6, 2, 24, 0),
    },
  ];
